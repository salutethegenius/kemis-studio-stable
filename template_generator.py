															...
															<table cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px" width="100%">
																<tbody>
																	<tr>
																		...
																		<p style="Margin:0;margin-top:2px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:11px;line-height:14px;color:#666666;font-weight:normal;letter-spacing:0.3px;">Curated insights from The Bahamas</p>
																		</a>
																		</td>
																	</tr>
																</tbody>
